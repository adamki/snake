...
/***/ function(module, exports, __webpack_require__) {
	...
	var direction = 'down';
	var options = { canvas: canvas, context: ctx, direction: direction };
	...
	function snakeCollidesWithFood() {
	  if (food.x < snake.x + snake.width && food.x + food.width > snake.x && food.y < snake.y + snake.height && food.height + food.y > snake.y) {
	    // collision detected!
	    food.eaten;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Snake = (function () {
	  ...
	  _createClass(Snake, [{
	    key: 'entersPortal',
	    value: function entersPortal(portalSet) {
	      var blue = portalSet.entry;
	      var orange = portalSet.exit;

	      if (blue.x < this.x + this.width && blue.x + blue.width > this.x && blue.y < this.y + this.height && blue.height + blue.y > this.y) {
	        this.clearPortal(orange);
	      }

	      if (orange.x < this.x + this.width && orange.x + orange.width > this.x && orange.y < this.y + this.height && orange.height + orange.y > this.y) {
	        this.clearPortal(blue);
	      }
	    }
	  }, {
	    key: 'clearPortal',
	    value: function clearPortal(exit) {
