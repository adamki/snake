...
function changeDirection(e) {
  ...
  } else if (shouldMoveUp(e)) {
    snake.direction = "up";
  } else if (shouldMoveRight(e)) {
    snake.direction = "right"
  } else if (shouldMoveDown(e)) {
    snake.direction = "down"
  }
}

function shouldMoveLeft(e) {
  if (board.modes.vim === true ) {
    return (e.keyCode === 72) && snake.direction !== "right"
  } else {
    return (e.keyCode === 37) && snake.direction !== "right"
  }
}

function shouldMoveUp(e) {
  if(board.modes.vim === true ) {
    return (e.keyCode === 75) && snake.direction !== "down"
  } else {
    return (e.keyCode === 38) && snake.direction !== "down"
  }
}
function shouldMoveDown(e) {
  if(board.modes.vim === true ) {
    return (e.keyCode === 74) && snake.direction !== "up"
  } else {
    return (e.keyCode === 40) && snake.direction !== "up"
  }
}
function shouldMoveRight(e) {
  if(board.modes.vim === true ) {
    return (e.keyCode === 76) && snake.direction !== "left"
  } else {
    return (e.keyCode === 39) && snake.direction !== "left"
  }
}
